...
#-----------------------以上常规混淆设置------------------------------------
#-----------------------以下第三方包不混淆----------------------------------
-keep public class * extends com.studyhelper.baselib.mvp.BasePresenter      # 保持Activity类不被混淆
-keep public class * extends com.studyhelper.baselib.mvp.BaseViewDelegate      # 保持Activity类不被混淆
...
public class ThreadPoolUtil {
      ...
      public static ExecutorService getCachePool() {
            if (sCachePool == null) {
                  ...
                  sCachePool = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new
      ...
      public static ExecutorService newThread(int thread) {
            ...
            ThreadFactory factory = Executors.defaultThreadFactory();
            return new ThreadPoolExecutor(thread, thread, 0L, TimeUnit.MILLISECONDS, new

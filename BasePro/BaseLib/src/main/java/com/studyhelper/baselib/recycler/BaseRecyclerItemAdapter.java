package com.studyhelper.baselib.recycler;
...
public abstract class BaseRecyclerItemAdapter extends RecyclerView.Adapter<RecyclerHolder> {
       ...
       */
      protected abstract RecyclerViewHolder  getViewHolder(int viewType);
 
      @Override
      public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerViewHolder viewHolder = getViewHolder(viewType);
